...
<HEAD>
	...
	<link rel="stylesheet" href="<?php echo BASE_URL; ?>/styles/css/faq.css">
		<link rel="stylesheet" href="<?php echo BASE_URL; ?>/styles/css/responsive/resp-faq.css">
			...
			<section id="content-L">
				<article id="TOPICS">
					<section id="faq">
						...
						<div id="portfolio">
							<h2>Portfolio &amp; Tattoos</h2>
							<ol>
								<li>How much does a tattoo cost?</li>
									<li>With an answer</li>
								<li>Some question</li>
									<li>With an answer</li> </ol> </div>
						<div id="flash">
							<h2>Flash Artwork</h2>
							<ol>
								<li>Some question</li>
						...
						<div id="henna">
							...
							<ol>
								<li>Is henna safe?</li>
									<li>With an answer</li>
								<li>What is blue henna?</li>
									<li>With an answer</li> </ol> </div>
						<div id="jewelry">
							<h2>Piercing Jewelry</h2>
							<ol>
								<li>Some question</li>
									<li>With an answer</li>
								<li>Some question</li>
						...
						<div id="healing">
							...
							<ol>
								<li>Some question</li>
									<li>With an answer</li>
								<li>Some question</li>
									<li>With an answer</li> </ol> </div> </section>
					<!-- <section id="">
