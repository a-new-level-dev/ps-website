...
<!-- Pg. 06o, Painted Siren: Piercings & Jewelry - Retainers -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
			...
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							<!-- Group #1 -->
							<li class="jewelry-preview"><a href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0057-retainer.jpg" data-imagelightbox="f"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0057-retainer.jpg" title="Painted Siren Jewelry - Retainers" alt="Painted Siren Jewelry - Retainers"></a> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/septum.php#gallery"> <span class="arrow-left"></span>Septum</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/organics.php#gallery">Organics<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
