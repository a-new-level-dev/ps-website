			...
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							<!-- Group #1 -->
							<li class="jewelry-preview"><a class="lightboxTrigger" href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0109-nose-studs.jpg"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0109-nose-studs.jpg" title="Painted Siren Jewelry - Nose Rings &amp; Studs" alt="Painted Siren Jewelry - Nose Rings &amp; Studs"></a> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/fakebody#gallery"> <span class="arrow-left"></span>Fake Body</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/tongue#gallery">Barbells<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
