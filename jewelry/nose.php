...
<!-- Pg. 06f, Painted Siren: Piercings & Jewelry - Nose Rings & Studs -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Nose Rings &amp; Studs</title>
	...
	<section id="container">
		...
		<section id="content">
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						<h1>Nose Rings &amp; Studs</h1>
						<ul>
							<!-- Group #1 -->
							<li class="jewelry-preview"><a href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0109-nose-studs.jpg" data-imagelightbox="f"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0109-nose-studs.jpg" title="Painted Siren Jewelry - Nose Rings &amp; Studs" alt="Painted Siren Jewelry - Nose Rings &amp; Studs"></a> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/fakebody.php#gallery"> <span class="arrow-left"></span>Fake Body</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/tongue.php#gallery">Barbells<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
