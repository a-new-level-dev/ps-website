...
<!-- Pg. 06b, Painted Siren: Piercings & Jewelry - Plugs & Tunnels -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Plugs &amp; Tunnels</title>
			...
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							<!-- Group #1 -->
							<li class="jewelry-preview"><a href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0015-plugs.jpg" data-imagelightbox="f"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0015-plugs.jpg" title="Painted Siren Jewelry - Plugs &amp; Tunnels" alt="Painted Siren Jewelry - Plugs &amp; Tunnels"></a> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/belly.php#gallery"> <span class="arrow-left"></span>Belly</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/tapers.php#gallery">Stretching<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
