			...
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							<!-- Group #1 -->
							<li class="jewelry-preview"><a class="lightboxTrigger" href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0015-plugs.jpg"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0015-plugs.jpg" title="Painted Siren Jewelry - Plugs &amp; Tunnels" alt="Painted Siren Jewelry - Plugs &amp; Tunnels"></a> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/belly#gallery"> <span class="arrow-left"></span>Belly</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/tapers#gallery">Stretching<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
