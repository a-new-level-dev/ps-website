				...
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							...
							<li class="jewelry-preview"><!-- <a class="lightboxTrigger" href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Piercing Aftercare" alt="Painted Siren Jewelry - Piercing Aftercare"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/intimate#gallery"> <span class="arrow-left"></span>Intimate</a> </div>
						<div class="jewelry-home cols3"><a href="<?php echo BASE_URL; ?>/jewelry#gallery">Back to Jewelry</a> <br>
							...
							<div id="jewelry-list" class="dropup">
								...
								<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
								 	...
								 	<li><a href="<?php echo BASE_URL; ?>/jewelry/intimate#gallery">Intimate Body Jewelry</a> </li> </div> </div>
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/belly#gallery">Belly<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
