...
<!-- Pg. 06k, Painted Siren: Piercings & Jewelry - Cartilage & Tragus -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Cartilage &amp; Tragus</title>
	...
	<section id="container">
		...
		<section id="content">
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						<h1>Cartilage &amp; Tragus</h1>
						<ul>
							<!-- Group #1 --> <!-- REPLACE "gallery-thumb.png" WITH THE CORRECT PICTURE WHEN AVAILABLE" -->
							<li class="jewelry-preview"><!-- <a href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" data-imagelightbox="f"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Cartilage &amp; Tragus" alt="Painted Siren Jewelry - Cartilage &amp; Tragus"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/horseshoe.php#gallery"> <span class="arrow-left"></span>Horseshoe</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/nipple.php#gallery">Nipple<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
