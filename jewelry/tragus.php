				...
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							...
							<li class="jewelry-preview"><!-- <a class="lightboxTrigger" href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Cartilage &amp; Tragus" alt="Painted Siren Jewelry - Cartilage &amp; Tragus"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/horseshoe#gallery"> <span class="arrow-left"></span>Horseshoe</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/nipple#gallery">Nipple<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
