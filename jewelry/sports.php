				...
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							...
							<li class="jewelry-preview"><!-- <a class="lightboxTrigger" href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Sports" alt="Painted Siren Jewelry - Sports"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/organics#gallery"> <span class="arrow-left"></span>Organics</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/intimate#gallery">Intimate<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
