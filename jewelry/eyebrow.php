...
<!-- Pg. 06m, Painted Siren: Piercings & Jewelry - Eyebrow -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Eyebrow Jewelry</title>
			...
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							<!-- Group #1 -->
							<li class="jewelry-preview"><a href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0030-eyebrow.jpg" data-imagelightbox="f"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0030-eyebrow.jpg" title="Painted Siren Jewelry - Eyebrow" alt="Painted Siren Jewelry - Eyebrow"></a> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/nipple.php#gallery"> <span class="arrow-left"></span>Nipple</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/septum.php#gallery">Septum<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
