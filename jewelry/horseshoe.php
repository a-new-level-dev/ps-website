...
<!-- Pg. 06j, Painted Siren: Piercings & Jewelry - Circular Horseshoe -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Circular Horseshoe</title>
	...
	<section id="container">
		...
		<section id="content">
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						<h1>Circular Horseshoe</h1>
						<ul>
							<!-- Group #1 --> <!-- REPLACE "gallery-thumb.png" WITH THE CORRECT PICTURE WHEN AVAILABLE" -->
							<li class="jewelry-preview"><!-- <a href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" data-imagelightbox="f"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Circular Horseshoe" alt="Painted Siren Jewelry - Circular Horseshoe"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/bead.php#gallery"> <span class="arrow-left"></span>Captive Bead</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/tragus.php#gallery">Cartilage<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
