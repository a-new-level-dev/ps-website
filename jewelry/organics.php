...
<!-- Pg. 06p, Painted Siren: Piercings & Jewelry - Organics -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Organics Jewelry</title>
				...
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							...
							<li class="jewelry-preview"><!-- <a href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" data-imagelightbox="f"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Organics" alt="Painted Siren Jewelry - Organics"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/retainers.php#gallery"> <span class="arrow-left"></span>Retainers</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/sports.php#gallery">Sports<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
