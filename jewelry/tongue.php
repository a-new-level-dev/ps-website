...
<!-- Pg. 06g, Painted Siren: Piercings & Jewelry - Barbells & Tongue -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Barbells &amp; Tongue</title>
	...
	<section id="container">
		...
		<section id="content">
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						<h1>Barbells &amp; Tongue</h1>
						<ul>
							<!-- Group #1 -->
							<li class="jewelry-preview"><a href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0029-barbell.jpg" data-imagelightbox="f"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0029-barbell.jpg" title="Painted Siren Jewelry - Barbells &amp; Tongue" alt="Painted Siren Jewelry - Barbells &amp; Tongue"></a> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/nose.php#gallery"> <span class="arrow-left"></span>Nose Rings</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/lip.php#gallery">Labret<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
