...
<!-- Pg. 06l, Painted Siren: Piercings & Jewelry - Nipple -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Nipple Jewelry</title>
				...
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							...
							<li class="jewelry-preview"><!-- <a href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" data-imagelightbox="f"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Nipple" alt="Painted Siren Jewelry - Nipple"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/tragus.php#gallery"> <span class="arrow-left"></span>Cartilage</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/eyebrow.php#gallery">Eyebrow<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
