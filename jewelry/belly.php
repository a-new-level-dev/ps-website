			...
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						...
						<!-- Gallery Pictures -->
						<ul>
							<li class="jewelry-preview"><a class="lightboxTrigger" href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0008-bellyButton.jpg"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0008-bellyButton.jpg" title="Painted Siren Jewelry - Belly Button" alt="Painted Siren Jewelry - Belly Button"></a> </li> </ul>
						<!-- All Jewelry gallery navigation under the main pictures -->
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/aftercare#gallery"> <span class="arrow-left"></span>Aftercare</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/plugs#gallery">Plugs<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
