...
<!-- Pg. 06a, Painted Siren: Piercings & Jewelry - Belly Button -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Belly Button</title>
			...
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						...
						<!-- Gallery Pictures -->
						<ul>
							<li class="jewelry-preview"><a href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0008-bellyButton.jpg" data-imagelightbox="f"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0008-bellyButton.jpg" title="Painted Siren Jewelry - Belly Button" alt="Painted Siren Jewelry - Belly Button"></a> </li> </ul>
						<!-- All Jewelry gallery navigation under the main pictures -->
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/aftercare.php#gallery"> <span class="arrow-left"></span>Aftercare</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/plugs.php#gallery">Plugs<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
