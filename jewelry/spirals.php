...
<!-- Pg. 06d, Painted Siren: Piercings & Jewelry - Spirals & Pinchers -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Spirals &amp; Pinchers</title>
	...
	<section id="container">
		...
		<section id="content">
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						<h1>Spirals &amp; Pinchers</h1>
						<ul>
							<!-- Group #1 --> <!-- REPLACE "gallery-thumb.png" WITH THE CORRECT PICTURE WHEN AVAILABLE" -->
							<li class="jewelry-preview"><!-- <a href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" data-imagelightbox="f"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Spirals &amp; Pinchers" alt="Painted Siren Jewelry - Spirals &amp; Pinchers"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/tapers.php#gallery"> <span class="arrow-left"></span>Stretching</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/fakebody.php#gallery">Fake Body<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
