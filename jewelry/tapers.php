...
<!-- Pg. 06c, Painted Siren: Piercings & Jewelry - Tapers & Stretching Kits -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Tapers &amp; Stretching Kits</title>
	...
	<section id="container">
		...
		<section id="content">
			<section id="content-L">
				<article id="TOPICS">
					<section id="gallery">
						<h1>Tapers &amp; Stretching Kits</h1>
						<ul>
							<!-- Group #1 -->
							<li class="jewelry-preview"><a href="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0091-tapers-large.jpg" data-imagelightbox="f"><img src="<?php echo BASE_URL; ?>/pics/jewelry/jewelry-0091-tapers-large.jpg" title="Painted Siren Jewelry - Tapers &amp; Stretching Kits" alt="Painted Siren Jewelry - Tapers &amp; Stretching Kits"></a> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/plugs.php#gallery"> <span class="arrow-left"></span>Plugs</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/spirals.php#gallery">Spirals<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
