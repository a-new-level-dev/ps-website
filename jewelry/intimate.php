				...
				<article id="TOPICS">
					<section id="gallery">
						...
						<ul>
							...
							<li class="jewelry-preview"><!-- <a href="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" data-imagelightbox="f"> --><img src="<?php echo BASE_URL; ?>/pics/jewelry/gallery-thumb.png" title="Painted Siren Jewelry - Intimate Body Jewelry" alt="Painted Siren Jewelry - Intimate Body Jewelry"><!-- </a> --> </li>
						</ul>
						<div class="jewelry-prev cols3"><a href="<?php echo BASE_URL; ?>/jewelry/sports.php#gallery"> <span class="arrow-left"></span>Sports</a> </div>
						...
						<div class="jewelry-next cols3"><a href="<?php echo BASE_URL; ?>/jewelry/aftercare.php#gallery">Aftercare<span class="arrow-right"></span> </a> </div> </section>
				</article>
			</section>
