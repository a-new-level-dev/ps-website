...
<!-- Pg. 02a, Painted Siren: Portfolios - HEATHER TARKMAN -->
<!-- ********************************************* HEAD: START ********************************************** -->
<HEAD>
	...
	<title>PS.com: Heather Tarkman</title>
	...
	<section id="container">
		...
		<section id="content">
			...
			<section id="content-R">
				<section id="PROFILES">
					<h1>Heather Tarkman</h1>
					<h2 class="title ctrText">Owner / Artist</h2>
					<div class="bioPic"><img src="<?php echo BASE_URL; ?>/pics/shop/ppl/bioPic-heather.jpg" title="Heather Tarkman, Owner" alt="Heather Tarkman from The Painted Siren"></div>
					<p>A San Francisco Bay Area native, Heather, has owned and operated "The Painted Siren Tattoo Company" for 6 years. An active member of her community, dedicated to her craft and the quality of her work, she is excited to be able to create art in such a beautiful place with such wonderful people.</p>
					<blockquote>" I really try to take each and every tattoo commission into my heart. I have a commitment to myself and to these incredible clients to provide a place where anyone can feel safe to share their life through art, without judgment or hate. When the space is created and we are free, that's when the art can get really wild! "</blockquote>
				</section>
				<aside id="CONTACT">
